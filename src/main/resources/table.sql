CREATE TABLE IF NOT EXISTS `tb_user_info`(
	user_id int(5) auto_increment comment '用户id',
	user_name varchar(5) not null comment '用户名',
	user_picutre varchar(30) not null comment '用户头像',
	user_password varchar(15) not null comment '用户密码',
	user_mail varchar(20) not null comment '用户邮箱',
...
CREATE TABLE IF NOT EXISTS `tb_scenic_spot`(
	scenic_spot_id int(5) auto_increment comment'景点id',
...
CREATE TABLE IF NOT EXISTS `tb_user_dynamic`(
	dynamic_id int(5) auto_increment comment '动态id',
